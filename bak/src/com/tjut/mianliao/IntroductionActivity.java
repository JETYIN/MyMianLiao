...
public class IntroductionActivity extends Activity implements Callback, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pi != null) {
            mTvVersion.setText("面聊v" + pi.versionName + "版");
        }
