...
public class EduBackActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEduList.setAdapter(new ArrayAdapter<>(this, R.layout.list_item_tv_search_result, mEduBacks));
