...
public class NoticeManager implements MsTaskListener, ContactObserver {
    ...
    private void initSummaries() {
        NoticeSummary summary = new NoticeSummary(NoticeSummary.SUBZONE_SYS,
                R.string.ntc_sys_msg, R.drawable.ic_ntc_sys_msg);
        mSummaries.put(summary.subzone, summary);

        summary = new NoticeSummary(NoticeSummary.SUBZONE_NEWS,
                R.string.tab_my_college, R.drawable.ic_ntc_news);
        mSummaries.put(summary.subzone, summary);

        summary = new NoticeSummary(NoticeSummary.SUBZONE_FORUM,
                R.string.tab_forum, R.drawable.ic_ntc_forum);
        mSummaries.put(summary.subzone, summary);

        summary = new NoticeSummary(NoticeSummary.SUBZONE_JOBS,
                R.string.more_jobs, R.drawable.ic_ntc_jobs);
        mSummaries.put(summary.subzone, summary);

        summary = new NoticeSummary(NoticeSummary.SUBZONE_QA,
                R.string.more_qa, R.drawable.ic_ntc_qa);
        mSummaries.put(summary.subzone, summary);

        summary = new NoticeSummary(NoticeSummary.SUBZONE_BOUNTY,
                R.string.more_bounty, R.drawable.ic_ntc_bounty);
        mSummaries.put(summary.subzone, summary);

        summary = new NoticeSummary(NoticeSummary.SUBZONE_NF,
                R.string.nc_title, R.drawable.ic_ntc_new_friends);
        mSummaries.put(summary.subzone, summary);
    }
