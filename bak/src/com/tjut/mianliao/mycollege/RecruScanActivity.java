...
public class RecruScanActivity extends BaseActivity implements OnRefreshListener2<ListView> {
	...
	private void checkDayNightUI() {
		if (mIsNightMode) {
            mPtrJobs.setBackgroundResource(R.drawable.bg);
        }
	}
    ...
    private void updateJobInfo(View view, RecruitInfo job, int position) {
        ...
        if (!mShouldCircle) {
            ...
            if (mIsNightMode) {
            	view.setBackgroundColor(COLOR_TRANSPARENT_WHITE);
            }
        } else {
            if (job.isPersonal()) {
            ...
            if (mIsNightMode) {
            	view.setBackgroundResource(R.drawable.bg_job_view_content_black);
            }
        }
    }
    ...
    private class RecruJobsAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (type) {
                ...
                case TYPE_HEADER:
                	if (mIsNightMode) {
                		view.setBackgroundResource(R.drawable.bg_job_view_content_title);
                	}
                default:
                    break;
            }
