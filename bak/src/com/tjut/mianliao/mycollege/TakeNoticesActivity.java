...
public class TakeNoticesActivity extends BaseActivity implements OnClickListener, OnRefreshListener2<ListView> {
    ...
    private ThemeImageView mNewMemo, mNewHomework, mNewNote;
    ...
    private void checkDayNightUI() {
        if (mIsNightMode) {
            findViewById(R.id.ll_notice).setBackgroundResource(R.drawable.bg);
        }
    }
    ...
    private class getViewTask extends AsyncTask<Void, Void, View> {
        ...
        protected View doInBackground(Void... params) {
            ...
            mNewMemo = (ThemeImageView) v.findViewById(R.id.tv_new_memo);
            mNewNote = (ThemeImageView) v.findViewById(R.id.tv_new_notes);
            mNewHomework = (ThemeImageView) v.findViewById(R.id.tv_new_homework);
