...
public class UpdateProfileImageActiivity extends BaseActivity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mIsNightMode) {
            findViewById(R.id.ll_image).setBackgroundResource(R.drawable.bg);
        } else {
            findViewById(R.id.ll_image).setBackgroundColor(0XFFF2F2F2);
        }
    }
    ...
    private class UpdateInfoTask extends MsMhpTask{
        ...
        public UpdateInfoTask(HashMap<String, String> parameters, HashMap<String, String> files) {
            super(UpdateProfileImageActiivity.this, MsRequest.UPDATE_PROFILE, parameters, files);
        }
