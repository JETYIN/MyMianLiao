...
import com.tjut.mianliao.black.MagicRelativeLayout;
...
public class MemoDetailActivity extends BaseActivity {
	...
	private MagicRelativeLayout mRlMemoDetail;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mRlMemoDetail = (MagicRelativeLayout) findViewById(R.id.rl_memo_detail);
	...
	private void checkDayNightUI() {
		if (mIsNightMode) {
			mRlMemoDetail.setBackgroundResource(R.drawable.bg);
			mLyMemo.setBackgroundColor(0X4D000000);
		} else {
			mLyMemo.setBackgroundColor(mNoteInfo.color * (-1));
		}
	}
