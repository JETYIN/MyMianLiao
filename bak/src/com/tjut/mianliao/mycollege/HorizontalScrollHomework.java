...
public class HorizontalScrollHomework extends HorizontalScrollView implements OnClickListener {
    ...
    public View mNullView(int i) {
        ...
        if (i == 0) {
            ...
            mRlNull.setBackgroundResource(mIsNightMode ? R.drawable.memo_bottom_bg_border_black
                    : R.drawable.memo_bottom_bg_border);
            ...
            RelativeLayout mRlNull = (RelativeLayout) v.findViewById(R.id.rl_note_detail);
            mRlNull.setBackgroundResource(mIsNightMode ? R.drawable.school_black_pic_bg_border
                    : R.drawable.school_pic_bg_border);
