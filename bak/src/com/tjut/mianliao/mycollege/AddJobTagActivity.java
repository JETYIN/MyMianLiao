...
public class AddJobTagActivity extends BaseActivity implements TagClickListener,
	...
	private void checkDayNightUI() {
		if (mIsNightMode) {
            findViewById(R.id.ll_add_tag).setBackgroundResource(R.drawable.bg);
            mTagMine.setBackgroundColor(Color.TRANSPARENT);
            mTagView.setBackgroundColor(Color.TRANSPARENT);
        }
	}
