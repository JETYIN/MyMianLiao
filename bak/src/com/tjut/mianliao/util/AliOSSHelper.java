...
public class AliOSSHelper {
    ...
    private static final String OSS_BUCKET = "tjt-post";
    private static final String OSS_URL_HEADER = "tjt-post.oss-cn-hangzhou.aliyuncs.com";
    ...
    public OSSBucket getOssBucket() {
        return new OSSBucket(OSS_BUCKET);
    }

    public String getUrl(int type, String fileName) {
        StringBuilder sb = new StringBuilder(OSS_URL_HEADER);
        switch (type) {
            case TYPE_IMAGE:
