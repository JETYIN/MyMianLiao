...
public class SnsHelper implements UMShareBoardListener, SnsPostListener {
    ...
    private static final String DEFAULT_IMG_URL = "http://image.tjut.cc/assets/images/logo/logo_v3.png";
    private static final String DEFAULT_TARGET_URL =
            "http://52mianliao.com/?s=265d939b46522daa2342e9c25dc3988b";
    ...
    public void openShareBoard(Activity activity, CfPost post) {
        ...
        prepareShare(activity, content, post.publicUrl, post.image);
        mShareController.openShare(activity, this);
    }
    ...
    @Override
    public void onStart() {
        mIncShareTasks.add(new IncShareTask(mIncShareType, mIncShareId));
    }
