...
public class EmotionsDetailActivity extends BaseActivity implements IMResourceListener,
    ...
    private boolean mIsNightMode, mHasContent;
    ...
    private void checkDayNightUI() {
        if (mIsNightMode) {
            findViewById(R.id.ll_emotion_detail).setBackgroundResource(R.drawable.bg);
        }
    }
    ...
    private class PagerAdapter extends ViewSwitcherAdapter {
        ...
        @Override
        public int getCount() {
            System.out.println("<=== mPageEmotions = " + mPageEmotions.size());
