...
DialogInterface.OnClickListener, TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mIsNightMode) {
            findViewById(R.id.rl_point).setBackgroundResource(R.drawable.bg);
        } else {
            findViewById(R.id.rl_point).setBackgroundColor(0XFFF2F2F2);
        }
    }
    ...
    private void showExchargeDialog() {
        if (mExchargeDialog == null) {
            mExchargeDialog = new LightDialog(this).setTitleLd("付款提示")
