...
public class VipCenterActivity extends BaseActivity implements OnClickListener {
    ...
    private ArrayList<VCenterListInfo> mHotList;
    private ArrayList<VCenterListInfo> mExtList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHotList = new ArrayList<VCenterListInfo>();
        mExtList = new ArrayList<VCenterListInfo>();
    ...
    private void checkDayNightUI() {
        if (mIsNightMode) {
            findViewById(R.id.sv_vip).setBackgroundResource(R.drawable.bg);
        } else {
            findViewById(R.id.sv_vip).setBackgroundColor(0XFFF2F2F2);
        }
    }
...
//                Intent intent = new Intent(VipCenterActivity.this,  );
    ...
    private void updateView() {
        mTvOpenVip.setText(mUserInfo.vip ? "续费会员" : "成为会员");
        mTvBecomeVip.setText(mUserInfo.vip ? "续费会员" : "成为会员");
        ...
        protected void onPostExecute(MsResponse response) {
            ...
            if (response.isSuccessful()) {
                ...
                if (mUserInfo.vip) {
                    ...
                    mTvVipEndtime.setText("到期时间"+Utils.getTimeString(5, vipEndTime));
                }
