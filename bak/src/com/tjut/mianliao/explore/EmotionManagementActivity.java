...
public class EmotionManagementActivity extends BaseActivity implements IMResourceListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mIsNightMode) {
            findViewById(R.id.ll_emotion).setBackgroundResource(R.drawable.bg);
            mLvUsing.setBackgroundColor(Color.TRANSPARENT);
            mLvCanAdd.setBackgroundColor(Color.TRANSPARENT);
        } else {
            findViewById(R.id.ll_emotion).setBackgroundColor(0XFFF2F2F2);
            mLvUsing.setBackgroundColor(Color.WHITE);
            mLvCanAdd.setBackgroundColor(Color.WHITE);
        }
    }
