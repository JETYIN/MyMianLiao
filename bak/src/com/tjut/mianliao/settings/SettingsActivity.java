...
public class SettingsActivity extends BaseActivity implements DialogSetting.Listener, OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cbs = (CheckBoxSetting) findViewById(R.id.setting_check_day_night);
        cbs.setTitle(R.string.setting_check_day_night);
        cbs.setKey(Settings.KEY_CHECK_DAY_NIGHT);
        ...
        tvLevel.setText(getString(R.string.setting_safe_level, "中"));
        ...
        if (mIsNightMode) {
            findViewById(R.id.sv_setting).setBackgroundResource(R.drawable.bg);
        } else {
            findViewById(R.id.sv_setting).setBackgroundColor(0XFFF2F2F2);
        }
