...
public class TribesListActivity extends BaseActivity implements OnRefreshListener2<ListView>,
        OnClickListener {
    ...
    private class TribesListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Picasso.with(TribesListActivity.this).load(tribe.icon).into(holder.mIvTribeLogo);
            
            holder.mTvTribeName.setText(tribe.tribeName);
            holder.mTvTribeDesc.setText(tribe.tribeDesc);
            holder.mTvTribeClass.setText(tribe.getTypeName(TribesListActivity.this, tribe.tribeType));
    ...
    private class ViewHoder {
        ...
        ThemeTextView mTvTribeClass;
        @ViewInject(R.id.tv_people_num)
        ThemeTextView mTvPeopleNum;
        @ViewInject(R.id.tv_is_concern)
        ThemeTextView mTvIsConcern;
    ...
    private void fetchTribes(boolean refresh) {
        ...
        if (mType == 0) {
            ...
            new GetTribesTask(offset, MsRequest.TRIBE_LATEST_TRIBE_LIST).executeLong();
        }
    }
    ...
    private class FollowTribeTask extends MsTask {
        ...
        public FollowTribeTask(TribeInfo tribeInfo) {
            super(TribesListActivity.this, !tribeInfo.collected ? MsRequest.TRIBE_FOLLOW_WITH
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rl_tribe_item:
                ...
                Intent intent = new Intent(TribesListActivity.this, TribeDetailActivity.class);
