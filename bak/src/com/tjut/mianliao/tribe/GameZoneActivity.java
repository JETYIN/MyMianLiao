...
public class GameZoneActivity extends BaseActivity implements OnRefreshListener2<ListView>,
		OnClickListener {
    ...
    private ThemeImageView mIvGoMiniGame;
    ...
    private class GameTribesAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.list_item_hot_tribe, parent, false);
            ...
            if (tribe.icon != null && !tribe.icon.equals("")) {
                Picasso.with(GameZoneActivity.this)
                    .load(tribe.icon)
            ...
            holder.mTvPostNum.setText(getString(R.string.tribe_is_followed_count_post,
                    tribe.threadCount));
            holder.mTvUpCount.setText(getString(R.string.tribe_homepage_up_count_desc, 
                    tribe.upCount));
            holder.mTribe = tribe;
    ...
    private OnClickListener mTribeOnclick = 
            new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(GameZoneActivity.this, TribeDetailActivity.class);
    ...
    private void viewMarket(MsRequest request) {
        Intent iMarket = new Intent(GameZoneActivity.this, AvatarMarketActivity.class);
    ...
    private class GetGameTribeTask extends MsTask{
		...
		protected String buildParams() {
			return new StringBuilder()
				.append("tribe_type=").append(mType)
				.append("&tribe_id=").append(mTribeId)
				.toString();
		}
