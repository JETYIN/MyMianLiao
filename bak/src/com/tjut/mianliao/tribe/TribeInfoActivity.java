...
public class TribeInfoActivity extends BaseActivity {
    ...
    private void checkDayNightUI() {
        if (mIsNightMode) {
            findViewById(R.id.sv_content).setBackgroundResource(R.drawable.bg);
        }
    }
    ...
    private BaseAdapter mChiefAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Picasso.with(TribeInfoActivity.this).load(chief.avatar).into(holder.mIvAvata);
            holder.mTvUserName.setText(chief.nickName);
            holder.mIvUserGander.setImageResource(chief.sex == 0 ? R.drawable.ic_female : R.drawable.ic_male);
