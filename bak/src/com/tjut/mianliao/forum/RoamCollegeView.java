...
public class RoamCollegeView extends LinearLayout implements OnSearchTextListener,
    ...
    public RoamCollegeView(Context context, AttributeSet attrs) {
        ...
        this.initAdapters();
        checkDayNightUI(view.findViewById(R.id.fl_roam_college_top));
        ...
        public void onItemClick(AdapterView<?> arg0, View view, int arg2, long arg3) {
            ...
            if (arg0 == mLvSearch) {
                ...
                if (!mSearchResults.get(arg2).isUnlock()) {
                	Toast.makeText(mContext, "该学校尚未解锁!", Toast.LENGTH_SHORT).show();
                	return;
                }
            } else {
...
//                    }
    ...
    private void checkDayNightUI(View view) {
        if (mIsNightMode) {
            view.setBackgroundResource(R.drawable.pic_bg_roam_college_black);
        } 
    }
