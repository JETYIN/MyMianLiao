...
public class NormalPostActivity extends BasePostActivity implements OnTouchListener,
    ...
    private ProgressBar mProgressBar, mProgressBarBlack;
    ...
    private void initView() {
        ...
        mProgressBarBlack = (ProgressBar) findViewById(R.id.pb_circle_black);
        ...
        if (mIsNightMode) {
            mTvTime.setBackgroundResource(R.drawable.circle_voice_post_showtime_bg_black);
            mTvTime.setTextColor(0xffb8b6ba);
            mIvTopic.setClickable(false);
            mIvRefFriend.setClickable(false);
        }
    }
    ...
    private void startVoiceRecord() {
        if (mIsNightMode)
            mProgressBarBlack.setVisibility(View.VISIBLE);
        else
    ...
    private void stopVoiceRecord() {
        ...
        if (mIsNightMode)
            mProgressBarBlack.setVisibility(View.GONE);
        else
            mProgressBar.setVisibility(View.GONE);
        if (mHasVoiceFile) {
