...
import com.tjut.mianliao.theme.ThemeImageView;
...
public class SearchActivity extends BaseActivity implements OnClickListener,
    ...
    private ThemeTextView mTvSearchHistory;
    private ThemeTextView mTvSearchSchool;
    private ThemeTextView mTvSearchTribe;
    private ThemeTextView mTvSearchPost;
    
    private ThemeTextView mTvSearchUser;
    private ThemeTextView mTvCampusPost;
    ...
    private ArrayList<CfPost> mSearchPosts;
    ...
    private ThemeTextView mTvClearHistory, mTvSearchHot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsNightMode = mSettings.isNightMode();
        mTvSearchHistory = (ThemeTextView) findViewById(R.id.tv_search_history);
        mTvSearchSchool = (ThemeTextView) findViewById(R.id.tv_search_school);
        mTvSearchTribe = (ThemeTextView) findViewById(R.id.tv_search_tribe);
        mTvSearchPost = (ThemeTextView) findViewById(R.id.tv_search_post);
        mTvSearchUser = (ThemeTextView) findViewById(R.id.tv_search_user);
        ...
        mTvClearHistory = (ThemeTextView) findViewById(R.id.tv_clear_history);
        mTvCampusPost = (ThemeTextView) findViewById(R.id.tv_campus_post);
        mTvSearchHot = (ThemeTextView) findViewById(R.id.tv_search_hot);
        ...
        mSearchPosts = new ArrayList<CfPost>();
        ...
        mTtSchool.setNightMode(mIsNightMode);
        mTtTribe.setNightMode(mIsNightMode);
        mTtPost.setNightMode(mIsNightMode);
        mTtUser.setNightMode(mIsNightMode);
    ...
    private void checkDayNightUI() {
        if (mIsNightMode) {
            findViewById(R.id.ll_activity_search).setBackgroundResource(R.drawable.bg);
            findViewById(R.id.search_type_tab_layout).setBackgroundColor(0X32000000);
            findViewById(R.id.ll_search_hot).setBackgroundColor(0X32000000);
            mGvHotSearch.setBackgroundColor(0X32000000);
            mLlSearchHistory.setBackgroundColor(0X32000000);
            mTvSearchHistory.setBackgroundColor(0X32000000);
            mPtrSearchHistory.setBackgroundColor(0X32000000);
            mTvClearHistory.setBackgroundColor(0X32000000);
            mPtrSearchResults.setBackgroundColor(0X32000000);
        } else {
            mPtrSearchResults.setBackgroundColor(0XFFFFFFFF);
        }
    }
    ...
    private BaseAdapter mSearchSchoolAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(mIsNightMode){
                view.setBackgroundColor(0X32000000);
            }
            SchoolInfo mSearchSchool = mSearchSchools.get(position);
            ThemeTextView mTvSchoolName = (ThemeTextView) view.findViewById(R.id.tv_school_name);
            ThemeImageView mIvIslock = (ThemeImageView) view.findViewById(R.id.iv_is_lock);
    ...
    private BaseAdapter mSearchTribeAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                viewHolder.mTvTribeName = (ThemeTextView) convertView.findViewById(R.id.tv_channel_name);
                viewHolder.mTvTribeDesc = (ThemeTextView) convertView.findViewById(R.id.tv_channel_desc);
                convertView.setTag(viewHolder);
            }
            if(mIsNightMode){
                convertView.setBackgroundColor(0X32000000);
            }
    ...
    private OnClickListener mTeribeClickListener = new OnClickListener() {
        ...
        @Override
        public void onClick(View v) {
            TribeInfo tribe = (TribeInfo) v.getTag();
    ...
    private class ViewHolderChannel {
        ...
        ThemeTextView mTvTribeName;
        ThemeTextView mTvTribeDesc;
        TribeInfo mTribe;
    }
    ...
    private BaseAdapter mSearchHistoryAdapter = new  BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ThemeTextView mTvSearchContent = (ThemeTextView) view.findViewById(R.id.tv_search_content);
            ThemeImageView mIvClearHistory = (ThemeImageView) view.findViewById(R.id.iv_clear_history);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.rl_history:
                    String seatchString = (String) v.getTag();
                    search(mSearchType, seatchString);
                    mLlSearchHistory.setVisibility(View.GONE);
                    mTvClearHistory.setVisibility(View.GONE);
                    mTvSearchHistory.setVisibility(View.GONE);
    ...
    private void search(int type, String name) {
        ...
        switch (type) {
            ...
            case 2:
                ...
                mTvCampusPost.setVisibility(View.VISIBLE);
                break;
            case 3:
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        if (mSearchText != null && !mSearchText.equals("")) {
            ...
            mTvCampusPost.setVisibility(View.GONE);
            mSearchHistorys = getHistoryList();
            mSearchHistoryAdapter.notifyDataSetChanged();
            mPtrSearchResults.setVisibility(View.GONE);
        }
            ...
            case SEARCH_TYPE_USER:
                ...
                if (searchText != null && !searchText.equals("")) {
                    if (!mIsNightMode) {
                        ...
                        toast(R.string.search_user_lock);
                    }
                }
                mTtSchool.setChosen(false);
                mTtTribe.setChosen(false);
