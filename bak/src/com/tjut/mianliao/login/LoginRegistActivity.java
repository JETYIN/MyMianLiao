...
public class LoginRegistActivity extends BaseActivity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonLogin = (Button) findViewById(R.id.bt_log_login);
        mButtonRegister = (Button) findViewById(R.id.bt_log_register);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_qq_login:
                ...
                break;
            case R.id.iv_renren_login:
                mSnsHelper.loginByExt(LoginRegistActivity.this, SHARE_MEDIA.RENREN);
                mUserExtLoginManager.setIsCancleLoginByExt(false);
                mButtonLogin.setEnabled(false);
                mButtonRegister.setEnabled(false);
                break;
