...
public class CourseSearchActivity extends BaseActivity implements DialogInterface.OnClickListener,
    ...
    private void checkDayNightUI() {
        if (mIsNightMode) {
            findViewById(R.id.ll_search_course).setBackgroundResource(R.drawable.bg);
            mLvCourseSearch.getRefreshableView().setDivider(getResources().getDrawable(R.color.hr_divider_black));
            mTvInfo.setBackgroundColor(Color.TRANSPARENT);
        }
    }
