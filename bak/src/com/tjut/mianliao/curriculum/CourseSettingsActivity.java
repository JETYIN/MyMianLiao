...
public class CourseSettingsActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ds.setBackgroundColor(mIsNightMode ? Color.TRANSPARENT : Color.WHITE);
        ...
        cbs.setBackgroundColor(mIsNightMode ? Color.TRANSPARENT : Color.WHITE);
        ...
        is.setBackgroundColor(mIsNightMode ? Color.TRANSPARENT : Color.WHITE);
        ...
        if (mIsNightMode) {
            findViewById(R.id.sv_course_setting).setBackgroundResource(R.drawable.bg);
        } else {
            findViewById(R.id.sv_course_setting).setBackgroundColor(0XFFF2F2F2);
