...
import com.tjut.mianliao.notice.NoticeBountyActivity;
import com.tjut.mianliao.notice.NoticeForumActivity;
import com.tjut.mianliao.notice.NoticeNewsActivity;
import com.tjut.mianliao.notice.NoticeQaActivity;
...
public class NoticeSummary {
    ...
    public static final int SUBZONE_BOUNTY = 6;
    ...
    public static Intent getIntent(Context context, int subzone) {
        ...
        switch (subzone) {
            ...
            case NoticeSummary.SUBZONE_NEWS:
                intent.setClass(context, NoticeNewsActivity.class);
                break;

            case NoticeSummary.SUBZONE_FORUM:
                intent.setClass(context, NoticeForumActivity.class);
                break;
            ...
            case NoticeSummary.SUBZONE_QA:
                intent.setClass(context, NoticeQaActivity.class);
                break;

            case NoticeSummary.SUBZONE_BOUNTY:
                intent.setClass(context, NoticeBountyActivity.class);
                break;
