...
//        inflater.inflate(R.layout.hr_divider_with_margin, this);
        ...
        item.findViewById(R.id.ll_item).setBackgroundColor(mIsNightMode ? Color.TRANSPARENT : Color.WHITE);
    ...
    protected void persistBoolean(boolean value) {
        ...
        if (mKey.equals(Settings.KEY_CHECK_DAY_NIGHT)) {
            Intent intent = new Intent(mContext, NightAnimActivity.class);
