...
public class PageIndicator extends View {
    private static final int INDICATOR_COLOR = 0x4DFFFFFF;
    private static final int INDICATOR_COLOR_BLACK = 0x32FFFFFF;
    private static final int INDICATOR_COLOR_HL = 0xff999999;
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attr) {
                case R.styleable.PageIndicator_dotColor:
                    mDotColor = ta.getColor(attr, mIsNightMode ? INDICATOR_COLOR_BLACK : INDICATOR_COLOR);
                    break;
                case R.styleable.PageIndicator_dotColorSelected:
                    mDotColorSelected = ta.getColor(attr, mIsNightMode ? INDICATOR_COLOR_HL_BLACK : INDICATOR_COLOR_HL);
                    break;
