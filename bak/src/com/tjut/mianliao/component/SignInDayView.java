...
public class SignInDayView extends LinearLayout {
    ...
    private int[] mTitleLayoutIds = { R.id.tv_title1, R.id.tv_title2, R.id.tv_title3, R.id.tv_title4, R.id.tv_title5,
            R.id.tv_title6, R.id.tv_title7 };
