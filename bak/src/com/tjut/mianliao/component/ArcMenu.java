...
public class ArcMenu extends ViewGroup implements OnClickListener {
    ...
    public ArcMenu(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = (int) a.getDimension(R.styleable.ArcMenu_radius,
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 100,
                        getResources().getDisplayMetrics()));
        Utils.logD(TAG, "position = " + mPosition + ", radius = " + mRadius);
        a.recycle();
    }
    ...
    private void layoutItemButton() {
        ...
        for (int i = 0; i < count - 1; i++) {
            ...
            if (mPosition == Position.RIGHTF_TOP || mPosition == Position.RIGHT_BOTTOM) {
    ...
    public void toggleMenu(int duration) {
        ...
        for (int i = 0; i < count - 1; i++) {
            ...
            if (mPosition == Position.LEFT_TOP || mPosition == Position.RIGHTF_TOP) {
                yflag = -1;
            }
    ...
    private void changeStatus() {
        ...
        if (mStatus == Status.OPEN) {
            ((View) getParent()).setBackgroundColor(0x4d000000);
            ((View) getParent()).setOnClickListener(mOnClicklistener);
            ((ImageView) mCButton).setImageResource(mIsNightMode ?
                    R.drawable.nomal_post_turnoff_black : R.drawable.nomal_post_turnoff);
        } else {
            ...
            ((View) getParent()).clearFocus();
            ((ImageView) mCButton).setImageResource(mIsNightMode ?
                    R.drawable.nomal_post_text_black : R.drawable.nomal_post_text);
        }
