...
import com.tjut.mianliao.R.color;
...
public class FocusDialog extends Dialog {
	...
	public FocusDialog(Context context, int theme) {
		...
		isNightMode = Settings.getInstance(mContext).isNightMode();
	...
	@SuppressLint("ResourceAsColor")
	private void init() {
		findViewById(R.id.relative_top).setBackgroundColor(
				R.drawable.dialog_night);
		findViewById(R.id.dialog_image).setBackgroundColor(
			R.drawable.dialog_image_night);
		((TextView) findViewById(R.id.tv_title))
				.setTextColor(R.color.dialog_top);
		((TextView) findViewById(R.id.tv_desc))
				.setTextColor(R.color.dialog_middle);
		((TextView) findViewById(R.id.btn_positive))
				.setTextColor(R.color.dialog_button);
