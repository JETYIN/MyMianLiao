...
public class ReplyView extends LinearLayout implements View.OnClickListener {
    ...
    private void setViewBg() {
        setBackgroundResource(mIsNightMode ? R.drawable.bg_second_reply_black :
            R.drawable.bg_second_reply);
    }
    ...
    private View getView(CfReply reply) {
        ...
        if (reply != null) {
            ...
            tv.setTextColor(mIsNightMode ? 0XFF959595 : 0XFF2E2E2E);
            ...
            content = Utils.getColoredText(content, name1, mIsNightMode ?
                    mNameColorNight : mNameColorNormal, true);
            content = Utils.getColoredText(content, name2, mIsNightMode ?
                    mNameColorNight : mNameColorNormal, true);
