...
public class LatestVisitorActivity extends BaseActivity implements OnRefreshListener2<ListView> {
    ...
    public void updateVisitCountInfo() {
        mTvTotalNum.setText(getString(R.string.prof_visitor_latest_desc, mScanTotle, mScanToday));
    }
    ...
    private BaseAdapter mVisitorAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.list_item_latest_visitor, parent, false);
            ...
            holder.mTvName.setText(user.getDisplayName(LatestVisitorActivity.this));
    ...
    private OnClickListener mVistorListen = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(LatestVisitorActivity.this, ProfileActivity.class);
        ...
        protected void onPostExecute(MsResponse response) {
            if (response.isSuccessful()) {
                ...
                if (jsonObject != null) {
                    ...
                    mScanToday = response.getJsonObject().optInt("today_visit_times");
                    updateVisitCountInfo();
                }
            }
        }
