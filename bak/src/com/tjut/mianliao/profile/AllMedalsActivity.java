...
public class AllMedalsActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mIsNightMode) {
             findViewById(R.id.ll_medal).setBackgroundResource(R.drawable.bg);
             findViewById(R.id.tv_apply).setBackgroundColor(Color.TRANSPARENT);
             mPtrLvMedals.setBackgroundColor(Color.TRANSPARENT);
        } else {
            findViewById(R.id.ll_medal).setBackgroundColor(0XFFF2F2F2);
            findViewById(R.id.tv_apply).setBackgroundColor(Color.WHITE);
            mPtrLvMedals.setBackgroundColor(Color.WHITE);
        }
    }
