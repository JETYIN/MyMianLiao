...
public class MedalActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mIsNightMode) {
            findViewById(R.id.ll_demal).setBackgroundResource(R.drawable.bg);
            lvMedals.setBackgroundColor(Color.TRANSPARENT);
        } else {
            findViewById(R.id.ll_demal).setBackgroundColor(0XFFF2F2F2);
            lvMedals.setBackgroundColor(Color.WHITE);
        }
    }
