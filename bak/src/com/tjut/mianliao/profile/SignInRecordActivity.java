...
public class SignInRecordActivity extends BaseActivity implements OnRefreshListener2<ListView> {
    ...
    private void checkDayNightUI() {
        if (mIsNightMode) {
            findViewById(R.id.view_parent).setBackgroundResource(R.drawable.bg);
        }
    }
    ...
    private BaseAdapter mSignRecordAdapter  = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.mTvContinueRecord.setText("连续签到"+ mSignRecordInfo.continuousDay +"天");
            viewHolder.mTvGiftStart.setText("获得"+mSignRecordInfo.rewardName+"");
