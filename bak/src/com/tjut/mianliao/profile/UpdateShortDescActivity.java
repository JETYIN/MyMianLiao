...
//        mIvClear.setOnClickListener(this);
        ...
        if (mIsNightMode) {
            findViewById(R.id.ll_update_desc).setBackgroundResource(R.drawable.bg);
        } else {
            findViewById(R.id.ll_update_desc).setBackgroundColor(0XFFF2F2F2);
        }
    }
    ...
    private void quit() {
        ...
        data.putExtra(ProfileActivity.EXTRA_USER_DESC, getDesc());
