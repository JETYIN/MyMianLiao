...
public class UpdateNickActivity extends BaseActivity implements TextWatcher, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mIsNightMode) {
            findViewById(R.id.ll_update_nck).setBackgroundResource(R.drawable.bg);
        } else {
            findViewById(R.id.ll_update_nck).setBackgroundColor(0XFFF2F2F2);
        }
    }
    ...
    private void quit() {
        ...
        data.putExtra(ProfileActivity.EXTRA_NICK_NAME, getNick());
