...
public class StickyPtrGridView extends PullToRefreshGridView{
    private StickyScrollCallBack scrollCallBack;

    public StickyPtrGridView(Context context) {
        this(context, null);
    }

    public StickyPtrGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private Handler uiHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            int pos = msg.what;
            getRefreshableView().requestFocus();
            getRefreshableView().setSelection(0);
        };
    };

    public int getContentHeight() {
        GridView gridView = getRefreshableView();
