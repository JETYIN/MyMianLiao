...
public class HeartLayout extends RelativeLayout {
    ...
    /**抽象类AbstractPathAnimator由PathAnimator实现**/
...
/**点击区域触发，1.设置bitmap颜色，2，生成HeartView为心形图像，3.动画显示区域**/
    ...
    public void addHeart(int heartResId, int heartBorderResId) {
        HeartView heartView = new HeartView(getContext());
        heartView.setColorAndDrawables(randomColor(), heartResId, heartBorderResId);
        mAnimator.start(heartView, this);
    }
