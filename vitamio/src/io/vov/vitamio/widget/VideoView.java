...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    private OnMediaPlayerListen mMediaPlayListen;
    ...
    private OnCompletionListener mCompletionListener = new OnCompletionListener() {
        public void onCompletion(MediaPlayer mp) {
            ...
            if (mMediaController != null) {
                mMediaController.hide();
                mMediaController.setProgress(0);
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mMediaPlayListen != null) {
                mMediaPlayListen.ObtainMediaPlay();
            }
            if (getCacheDir() != null) {
                mMediaPlayer.setUseCache(true);
                mMediaPlayer.setCacheDirectory(getCacheDir());
            }
    ...
    public void setMediaPlayListen(OnMediaPlayerListen l) {
        mMediaPlayListen = l;
    }
    ...
    public interface OnMediaPlayerListen {
        public void ObtainMediaPlay();
    }
