...
public class MediaController extends FrameLayout {
  ...
  public void setProgress(int pos) {
        pos = pos <= 0 ? 0 : pos;
        pos = pos >= mProgress.getMax() ? mProgress.getMax() : pos;
  ...
  public void updatePausePlay() {
    ...
    if (mPlayer.isPlaying())
      mPauseButton.setImageResource(getResources().getIdentifier("icon_video_stop", "drawable", mContext.getPackageName()));
    else
      mPauseButton.setImageResource(getResources().getIdentifier("icon_video_start", "drawable", mContext.getPackageName()));
  }
